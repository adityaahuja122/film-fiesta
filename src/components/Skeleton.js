...
const renderSkeletons = (numOfSkeletons = 3) => {
  const skeletons = [];
...
const Skeleton = () => {
  return (
    <div
      role="status"
      className="max-w-sm p-4 border border-gray-200 rounded shadow animate-pulse p-6 dark:border-gray-700 m-2"
    >
      <div className="flex items-center justify-center h-48 mb-4 bg-gray-300 rounded dark:bg-gray-700">
        <svg
          className="w-[382px] h-10 text-gray-200 dark:text-gray-600"
          aria-hidden="true"
